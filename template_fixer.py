#!/usr/bin/env python3
"""
Fix the populated template by using proper ODT XML formatting
"""
...
def fix_populated_template():
    """
    Fix the populated template by using proper XML line breaks instead of \n
    """
    
    reference_path = "/home/johnny5/Squirt/template_reference/waterwizard_reference_template.odt"
    output_path = "/home/johnny5/Squirt/template_reference/fixed_populated_contract.odt"
    
    # Extract the working template
    extract_dir = "/home/johnny5/Squirt/template_reference/fixed_extract"
    ...
    # Replace placeholders with properly formatted XML data
    replacements = {
        ...
        '{{CONTRACTOR_ADDRESS}}': '456 Business Ave<text:line-break/>Portland, OR 97201',
        ...
        '{{MATERIALS_LIST}}': '• 2x Rain Bird electronic valves @ $175.00 each = $350.00<text:line-break/>• 8x Sprinkler heads @ $45.00 each = $360.00<text:line-break/>• 150ft trenching in turf @ $6.50/ft = $975.00',
        '{{LABOR_DETAILS}}': '• System design and planning: 2 hours<text:line-break/>• Installation and testing: 6 hours<text:line-break/>• Total labor: 8 hours @ $85.00/hour = $680.00',
        '{{SUBTOTAL}}': '2,365.00',
        '{{TAX_AMOUNT}}': '0.00',
    ...
    print(f"✅ Created fixed populated template: {output_path}")
...
if __name__ == "__main__":
    result = fix_populated_template()
    print(f"📄 Please test opening: {result}")
    print("🔍 Key fixes:")
    print("  - Used <text:line-break/> instead of \\n")
    print("  - Properly escaped & as &amp;") 
    print("  - Should now validate as proper XML")